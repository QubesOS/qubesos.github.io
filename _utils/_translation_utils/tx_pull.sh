...
tx pull -l $1 --mode reviewed -d --traceback -r qubes.*doc*
tx pull -l $1 --mode reviewed -d --traceback -r qubes.*pages*
tx pull -l $1 --mode reviewed -d --traceback -r qubes.*news*
...
tx pull -l $1 --mode sourceastranslation -d --traceback -r qubes.*data_*
