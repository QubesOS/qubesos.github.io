...
tx pull --force -l $1 --mode reviewed --traceback -r qubes.doc*
tx pull --force -l $1 --mode reviewed --traceback -r qubes.pages*
tx pull --force -l $1 --mode reviewed --traceback -r qubes.news*
...
tx pull --force -l $1 --mode sourceastranslation --traceback -r qubes.data_*
