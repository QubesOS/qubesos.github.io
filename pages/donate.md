...
### <i class="fa fa-2x fa-fw fa-bitcoin"></i> Bitcoin (BTC)
...
```
([How to verify our Bitcoin address](#how-do-i-verify-your-bitcoin-address))

### <i class="fa fa-2x fa-fw fa-brands fa-ethereum"></i> Ethereum (Mainnet only)
...
```
([How to verify our Ethereum address](#how-do-i-verify-your-ethereum-address))

### <i class="fab fa-2x fa-fw fa-monero"></i> Monero (XMR)
...
```
([How to verify our Monero address](#how-do-i-verify-your-monero-address))

### <i class="fa fa-2x fa-fw black-icon fa-credit-card"></i> Credit card or PayPal

[Donate on Open Collective.](https://opencollective.com/qubes-os)

### <i class="fa fa-2x fa-fw black-icon fa-bank"></i> Tax-deductible EU bank transfer

[Donate via EU bank transfer.](#how-can-i-donate-via-eu-bank-transfer)
